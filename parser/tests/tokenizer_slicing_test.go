...
func TestTokenizer_Slicing(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			input: "arr[1:4]",
			expected: []parser.Token{
				{Type: constants.TokenIdentifier, Value: "arr", Token: "arr"},
				{Type: constants.TokenLeftBracket, Value: "[", Token: "["},
				{Type: constants.TokenNumber, Value: float64(1), Token: "1"},
				{Type: constants.TokenColon, Value: ":", Token: ":"},
				{Type: constants.TokenNumber, Value: float64(4), Token: "4"},
				{Type: constants.TokenRightBracket, Value: "]", Token: "]"},
		...
		},
		{
			...
			expected: []parser.Token{
				...
				{Type: constants.TokenLeftBracket, Value: "[", Token: "["},
				{Type: constants.TokenColon, Value: ":", Token: ":"},
				{Type: constants.TokenNumber, Value: float64(3), Token: "3"},
				{Type: constants.TokenRightBracket, Value: "]", Token: "]"},
				{Type: constants.TokenEOF},
			},
		},
		...
		},
		{
			...
			expected: []parser.Token{
				{Type: constants.TokenIdentifier, Value: "arr", Token: "arr"},
				{Type: constants.TokenLeftBracket, Value: "[", Token: "["},
				{Type: constants.TokenNumber, Value: float64(0), Token: "0"},
				{Type: constants.TokenColon, Value: ":", Token: ":"},
				{Type: constants.TokenNumber, Value: float64(5), Token: "5"},
				{Type: constants.TokenColon, Value: ":", Token: ":"},
				{Type: constants.TokenNumber, Value: float64(2), Token: "2"},
				{Type: constants.TokenRightBracket, Value: "]", Token: "]"},
				{Type: constants.TokenEOF},
			},
		},
		{
			...
			expected: []parser.Token{
				...
				{Type: constants.TokenColon, Value: ":", Token: ":"},
				{Type: constants.TokenColon, Value: ":", Token: ":"},
				{Type: constants.TokenOperator, Value: "-", Token: "-"},
				{Type: constants.TokenNumber, Value: float64(1), Token: "1"},
				{Type: constants.TokenRightBracket, Value: "]", Token: "]"},
				{Type: constants.TokenEOF},
			},
