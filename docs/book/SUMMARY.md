...
- [Data Types](data-types.md)
  - [Numeric Semantics (NaN / Inf)](numeric-semantics.md)
...
- [Operators](operators/overview.md)
  ...
  - [Nullish Coalescing Operator (??)](operators/nullish-coalescing.md)
  - [Null Chaining Operator (?.)](operators/null-chaining.md)
  - [Slicing Operator](operators/slicing.md)
  - [Optional and Nullish Quick Reference](operators/nullish-and-optional-quickref.md)
- [Expressions](expressions.md)
- [Strings and Unicode](strings-unicode.md)
...
- [Performance and Build Configuration](performance.md)
